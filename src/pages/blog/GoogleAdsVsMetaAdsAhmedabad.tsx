...
const faqs = [
  {
    q: "Which is cheaper, Google Ads or Meta Ads, in Ahmedabad?",
    a: "Meta Ads generally have a lower cost per click and cost per impression across most categories, but \"cheaper\" doesn't automatically mean better ROI — Google's higher cost per click often comes with higher purchase intent, which can make it more efficient per actual sale despite the higher click price.",
  },
  {
    q: "Should a brand-new business with no website start with Google or Meta?",
    a: "Neither platform will perform well without at least a basic landing page to send traffic to. If forced to choose before a website exists, Meta can build initial awareness and a following, but investing in a simple, functional website should happen before serious ad spend on either platform.",
  },
  {
    q: "How long before I know if a campaign is working?",
    a: "Give Google Ads at least 3-4 weeks and enough spend to generate meaningful click data before judging performance. Give Meta Ads a similar window, ideally allowing the algorithm to exit its learning phase, which usually needs a reasonable volume of conversions within the first week or two of a campaign.",
  },
  {
    q: "Can small businesses in Ahmedabad really compete with bigger brands on these platforms?",
    a: "Yes, particularly on Meta, where precise audience targeting often matters more than budget size. On Google, competing for broad, expensive keywords is harder for smaller budgets, but targeting specific, local, lower-competition search terms can still work well against much bigger competitors.",
  },
  {
    q: "Do I need a digital marketing consultant to run these, or can I do it myself?",
    a: "Both platforms are accessible enough to learn on a small budget, and there's real value in understanding the basics yourself even if you eventually hand it off. That said, the learning curve costs real money in wasted spend while you figure out targeting, bidding, and creative — so many founders find it more efficient to bring in someone experienced once budgets grow past the testing stage.",
  },
];
        ...
        <div className="container-custom">
          ...
          <div className="grid lg:grid-cols-[minmax(0,1fr)_320px] gap-12 items-start">
            <div className="max-w-3xl">
              <Link to="/blog" className="inline-flex items-center text-sm font-semibold text-primary hover:underline mb-8">
                ← Back to blog
              </Link>
              ...
              <div className="space-y-8 text-lg text-muted-foreground leading-relaxed">
                <p>
                  Almost every founder I talk to in Ahmedabad asks some version of the same question when they're ready to spend on advertising for the first time: Google or Meta? Usually they've heard both are "essential," their budget only stretches to one right now, and nobody's given them a straight answer on which to start with.
                </p>
                <p>
                  I'm <Link to="/" className="text-primary font-semibold hover:underline">Hitesh Jaganiya, a digital marketing consultant in Ahmedabad</Link>. I've spent 11 years in digital marketing here in Ahmedabad, and I'm certified in Google Ads and Google Analytics, with additional hands-on work using HubSpot and SEMrush for strategy and reporting. This isn't going to be a "it depends" non-answer — it does depend on a few specific things, but I'll walk you through exactly what those things are so you can actually decide for your own business, not just take my word for it.
                </p>
                ...
                {sections.map((section) => (
                  <section key={section.heading}>
                    ...
                    {section.paragraphs.map((paragraph, index) => (
                      <p key={index} className={index ? "mt-5" : ""}>{paragraph}</p>
                    ))}
                    {section.heading === "What I'd Actually Tell a Founder With a Limited Budget" && (
                      <p className="mt-5">
                        If you want help choosing between channels based on your actual business rather than a generic package, you can <Link to="/" className="text-primary font-semibold hover:underline">work with Hitesh Jaganiya</Link> and discuss where your budget is best spent.
                      </p>
                    )}
                  </section>
                ))}
              ...
              <div className="mt-12 p-8 bg-secondary/40 rounded-2xl border border-border text-center">
                <h2 className="text-2xl font-bold text-foreground mb-3">Need help choosing between Google Ads and Meta Ads?</h2>
                <p className="text-muted-foreground mb-6">Tell me what you sell, who you target, and your starting budget, and I can help you decide where to put your first advertising rupee.</p>
                <div className="flex flex-wrap justify-center gap-4">
                  <Button asChild size="lg">
                    <Link to="/#contact">Let’s talk <ArrowRight className="w-4 h-4 ml-1" /></Link>
                  </Button>
